...
public class FragmentLostGames extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.lostgames_fragment, container, false);
        myrecyclerview = (RecyclerView) v.findViewById(R.id.lostgames_recyclerview);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      // mDataBaseHelper.updateDataToUserActive(3);
        ...
        //mDataBaseHelper.addData(20500,"10.05.2019",200, 1);
        Cursor data = mDataBaseHelper.getData();

        while(data.moveToNext()) {
            String tempForMethod=data.getString(2);
            GameFunctions.getWinner(data, getContext());
            if( Integer.parseInt(data.getString(4))==1 && data.getString(5).equals("0")) {
